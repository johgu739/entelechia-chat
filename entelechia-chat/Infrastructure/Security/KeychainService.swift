...
// Signifier: KeychainService
// Substance: Secure credential storage service
// Genus: Infrastructure security helper
// Differentia: Wraps Keychain CRUD with logging and typed credentials
// Form: Protocol + concrete implementation
// Matter: Keychain queries; CODEX credential metadata
// Powers: Save, load, and delete secrets deterministically
// FinalCause: Provide secure, observable credential access for Codex readiness
// Relations: Serves CodexConfig loader and AppEnvironment composition
...
struct KeychainCredential: Equatable {
    ...
    static let codexAPIKey = KeychainCredential(
