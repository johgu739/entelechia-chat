...
private extension Bundle {
    static var appCompositionModule: Bundle = {
        let bundleName = "AppComposition_AppComposition"
        let candidates = [
            Bundle.main.resourceURL,
            Bundle(for: _AppCompositionBundleToken.self).resourceURL,
            Bundle.main.bundleURL,
            Bundle.main.bundleURL.deletingLastPathComponent(),
            Bundle(for: _AppCompositionBundleToken.self).bundleURL,
            Bundle(for: _AppCompositionBundleToken.self).bundleURL.deletingLastPathComponent()
        ]
        ...
        return Bundle(for: _AppCompositionBundleToken.self)
    }()
}
...
private final class _AppCompositionBundleToken {}

public struct CodexConfigLoader: CodexConfigLoading {
    public static var secretsBundle: Bundle = .appCompositionModule
